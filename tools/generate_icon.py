...
SIZE = 1024
OUT = Path('assets/branding/app_icon.png')

img = Image.new('RGB', (SIZE, SIZE), '#2F6BFF')
d = ImageDraw.Draw(img)

# Rounded outer shape on a light canvas is handled by the launcher platform.
# Desktop
...
# Small HAI sparkle
cx, cy = 795, 205
sparkle = [(cx, cy-58), (cx+18, cy-18), (cx+58, cy), (cx+18, cy+18),
